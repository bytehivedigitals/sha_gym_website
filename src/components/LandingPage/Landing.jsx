  ...
  return (
    <div className="relative bg-black text-white min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <img
        src={hitman}
        alt="Hitman"
        className="absolute inset-0 w-full h-full object-cover z-20 mt-[-3rem] !h-[45rem] md:!h-[50rem] lg:!h-[55rem]"
      />
      ...
      <div className="flex justify-center items-center gap-6 mb-8 z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* 1st Stat */}
          <div className="bg-gray-700 p-4 rounded-lg w-[5.5rem] h-[6.563rem] !rounded-[2rem] mt-[8rem] md:mt-[10rem] ml-[2rem] md:ml-[6rem]">
            <img
              src={clock}
              alt="Clock Icon"
          ...
          {/* 2nd Stat */}
          <div className="bg-gray-700 p-4 rounded-lg w-[5.5rem] h-[6.563rem] !rounded-[2rem] ml-[2rem] md:ml-[8rem] mt-[8rem] md:mt-[10rem]">
            <img
              src={poss}
              alt="Pose Icon"
              className="w-[6rem] h-8 ml-[-0.300rem]"
          ...
          {/* 3rd Stat */}
          <div className="bg-gray-700 p-4 rounded-lg w-[5.5rem] h-[6.563rem] !rounded-[2rem] ml-[2rem] md:ml-[4rem] mt-[12rem] md:mt-[14rem]">
            <img
              src={fire}
              alt="Fire Icon"
      ...
      <div className="absolute bottom-6 text-center z-20">
        {/* Footer Text */}
        <div className="mt-4">
          <p className="text-[2rem] md:text-[3rem] lg:text-[5rem] w-full md:w-[70rem] font-bold leading-tight">
