...
const Testimonials = () => {
  ...
  return (
    <div className="testimonial-container h-[fit-content] bg-black text-white text-center px-2 sm:px-4 py-12 sm:py-20">
      ...
      <div className="mt-5 flex flex-col md:flex-row items-center justify-between mb-12 pr-12">
        {/* Left Side */}
